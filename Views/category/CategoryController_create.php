<div class="form-container">
    <div class="category-header">
            <h2 class="category-header__title">Create Category</h2>
            <a href="<?= URL_ROOT ?>/category" class="category-header__back">back</a>
    </div>
    <form action="<?= URL_ROOT ?>/category/store" method="POST" class="category-create">
        <label for="title" class="category-create__label">Title</label><br>
        <input type="text" id="title" name="title" class="category-create__input"><br>
